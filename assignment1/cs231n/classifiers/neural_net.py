...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None, reg=0.0):
    ...
    # shape (N, C).                                                             #
    #############################################################################
    Z1 = np.dot(X, W1) + b1 # Z1.shape = (N, H)
    H1 = Z1
    H1[H1 < 0] = 0 # H1.shape = (N, H)
    # Alternatively, H1 = np.maximum(0, H1)
    Z2 = np.dot(H1, W2) + b2 # Z2.shape = (N, C)
    scores = Z2
    pass
    #############################################################################
    #                              END OF YOUR CODE                             #
  ...
  def train(self, X, y, X_val, y_val,
    ...
    for it in xrange(num_iters):
      ...
      #########################################################################
      random_batch_index = np.random.choice(np.arange(num_train), size=batch_size)
      X_batch = X[random_batch_index]
      y_batch = y[random_batch_index]
      #########################################################################
      #                             END OF YOUR CODE                          #
      #########################################################################
