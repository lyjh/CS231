...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        hidden, rnn_cache = rnn_forward(embedding, h0, Wx, Wh, b)
        temporal_affine, temporal_affine_cache = temporal_affine_forward(hidden, W_vocab, b_vocab)
    ...
    def sample(self, features, max_length=30):
        ...
        captions = np.c_[self._start * np.ones(N, dtype=np.int32), captions]
